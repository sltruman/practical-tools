...
eye_to_hand_transform = [[-0.9955322430611627,0.0028817025222408156,0.09437822214998369,-0.24240494262053444],[0.0013186702509287958,0.9998610162318016,-0.016619546584627724,-0.4114167017006515],[-0.09441299769834981,-0.016420840736168302,-0.9953976802540438,1.2696347107418071],[0.0,0.0,0.0,1.0]]

scene = Scene(1024, 768)
scene.load('./scenes/算法插件.json')
