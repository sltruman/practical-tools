...
class Printer3D(ActiveObject):
    def __init__(self,scene,**kwargs):
        self.print_height = kwargs['print_height'] # 打印高度
        self.width = kwargs['width']
        self.height = kwargs['height']
        self.depth = kwargs['depth']
        self.nozzle_diameter = kwargs['nozzle_diameter']
...
class G5Printer3D(Printer3D):
    def __init__(self,scene,**kwargs):
        kwargs['width'] = 0.500
        kwargs['height'] = 0.500
        kwargs['depth'] = 0.500
        kwargs['nozzle_diameter'] = 0.0008
        super().__init__(scene, **kwargs)



class G12Printer3D(Printer3D):
    def __init__(self,scene,**kwargs):
        kwargs['width'] = 1.200
        kwargs['height'] = 1.000
        kwargs['depth'] = 1.000
        kwargs['nozzle_diameter'] = 0.006 
        super().__init__(scene, **kwargs)
